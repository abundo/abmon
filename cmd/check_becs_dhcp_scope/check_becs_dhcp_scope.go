...
func main() {
	kong.Parse(&opts, kong.Name("check_becs_dhcp_scope"), kong.Description("Check free addresses in BECS DHCP scopes"), kong.Configuration(cmdbase.ConfigLoader), kong.Vars{"version": abmon.VersionString()})
