...
func main() {
	kong.Parse(&opts, kong.Name("check_imap_message_age"), kong.Description("Check the age of the oldest message in an IMAP folder"), kong.Configuration(cmdbase.ConfigLoader), kong.Vars{"version": abmon.VersionString()})
