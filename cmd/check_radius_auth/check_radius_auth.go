...
func main() {
	kong.Parse(&opts, kong.Name("check_radius_auth"), kong.Description("Check RADIUS authentication"), kong.Configuration(cmdbase.ConfigLoader), kong.Vars{"version": abmon.VersionString()})
